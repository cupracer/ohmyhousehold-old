...
class BrandVoter extends Voter
{
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token): bool
    {
        ...
        // you know $subject is an Brand object, thanks to `supports()`
        /** @var Brand $brand */
        $brand = $subject;

        $householdUser = $this->householdUserRepository->findOneBy([
            'user' => $user,
            'household' => $brand->getHousehold()
        ]);
    ...
    {
        // no further permissions than 'view' required to edit brands
        return $this->canView($householdUser);
    }
