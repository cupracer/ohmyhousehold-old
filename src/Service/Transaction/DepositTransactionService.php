...
class DepositTransactionService extends DatatablesService
{
    ...
    public function getDepositTransactionsAsDatatablesArray(Request $request, Household $household): array
    {
